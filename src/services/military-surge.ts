...
const POSTURE_THEATERS: PostureTheater[] = [
  ...
  },
  {
    ...
    thresholds: { elevated: 3, critical: 7 },
    navalThresholds: { elevated: 2, critical: 6 },
  ...
  },
  {
    ...
    thresholds: { elevated: 2, critical: 6 },
    navalThresholds: { elevated: 2, critical: 5 },
    strikeIndicators: { minTankers: 1, minAwacs: 1, minFighters: 2 },
  },
  {
  ...
  },
  {
    ...
    thresholds: { elevated: 2, critical: 5 },
    navalThresholds: { elevated: 1, critical: 4 },
    strikeIndicators: { minTankers: 1, minAwacs: 1, minFighters: 2 },
  },
  {
